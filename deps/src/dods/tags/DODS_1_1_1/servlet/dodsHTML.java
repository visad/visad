...
/* $Id: dodsHTML.java,v 1.1.1.1 2002-06-05 21:43:46 steve Exp $
*
*/
...
*/
    ...
    *
    * @param dServ The <code>DODSServlet</code> reference for the servlet
    * pbject that's running this show.
    *
    * @returns A DDS object built using the www interface class factory.
    *
    * @see dods.dap.DDS
    * @see dods.servers.www
