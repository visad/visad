// $Id: ProxySDInt16.java,v 1.1.1.1 2002-06-05 21:43:43 steve Exp $
/*
 ...
 * @author jcaron
 */
public class ProxySDInt16 extends SDInt16 implements HasProxyObject {
  ...
  */
  ProxySDInt16(DODSDataset df, String name) {
      super(name);
      this.df = df;
  }
  ...
  public boolean read(String datasetName, Object specialO) throws java.io.IOException {
    ...
    DInt16 v = (DInt16) enum.nextElement(); // better only be one! better be DVector!
    setValue( v.getValue());
