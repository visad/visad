// $Id: ProxySDFloat32.java,v 1.1.1.1 2002-06-05 21:43:43 steve Exp $
/*
...
public class ProxySDFloat32 extends SDFloat32 implements HasProxyObject {
  ...
  */
  ProxySDFloat32(DODSDataset df, String name) {
      super(name);
      this.df = df;
  }
  ...
  public boolean read(String datasetName, Object specialO) throws java.io.IOException {
    ...
    try {
      ...
      System.out.println("ProxySDFloat32 read getData failed = "+e);
      return false;
    }
    if (debugRead)  {
      System.out.println("ProxySDFloat32 dataDDS return");
