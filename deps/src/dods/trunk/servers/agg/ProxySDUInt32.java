// $Id: ProxySDUInt32.java,v 1.1.1.1 2002-06-05 21:43:43 steve Exp $
/*
 ...
 * @author jcaron
 */
public class ProxySDUInt32 extends SDUInt32 implements HasProxyObject {
  ...
  */
  ProxySDUInt32(DODSDataset df, String name) {
      super(name);
      this.df = df;
  }
  ...
  public boolean read(String datasetName, Object specialO) throws java.io.IOException {
    ...
    DUInt32 v = (DUInt32) enum.nextElement(); // better only be one! better be DVector!
    setValue( v.getValue());
