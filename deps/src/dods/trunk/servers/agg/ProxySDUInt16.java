// $Id: ProxySDUInt16.java,v 1.1.1.1 2002-06-05 21:43:43 steve Exp $
/*
 ...
 * @author jcaron
 */
public class ProxySDUInt16 extends SDUInt16 implements HasProxyObject {
  ...
  */
  ProxySDUInt16(DODSDataset df, String name) {
      super(name);
      this.df = df;
  }
  ...
  public boolean read(String datasetName, Object specialO) throws java.io.IOException {
    ...
    DUInt16 v = (DUInt16) enum.nextElement(); // better only be one! better be DVector!
    setValue( v.getValue());
