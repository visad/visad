// $Id: ProxySDString.java,v 1.1.1.1 2002-06-05 21:43:43 steve Exp $
/*
 ...
 * @author jcaron
 */
public class ProxySDString extends SDString implements HasProxyObject {
  ...
  */
  ProxySDString(DODSDataset df, String name) {
      super(name);
      this.df = df;
  }
  ...
  public boolean read(String datasetName, Object specialO) throws java.io.IOException {
    ...
    DString v = (DString) enum.nextElement(); // better only be one! better be DVector!
    setValue( v.getValue());
