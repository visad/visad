// $Id: ProxySDInt32.java,v 1.1.1.1 2002-06-05 21:43:43 steve Exp $
/*
 ...
 * @author jcaron
 */
public class ProxySDInt32 extends SDInt32 implements HasProxyObject {
  ...
  */
  ProxySDInt32(DODSDataset df, String name) {
      super(name);
      this.df = df;
  }
  ...
  public boolean read(String datasetName, Object specialO) throws java.io.IOException {
    ...
    DInt32 v = (DInt32) enum.nextElement(); // better only be one! better be DVector!
    setValue( v.getValue());
