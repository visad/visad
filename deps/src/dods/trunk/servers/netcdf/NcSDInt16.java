// $Id: NcSDInt16.java,v 1.1.1.1 2002-06-05 21:43:44 steve Exp $
/*
 ...
 * @author jcaron
 */
public class NcSDInt16 extends SDInt16 implements HasProxyObject {
  ...
  */
  ...
  public boolean read(String datasetName, Object specialO) throws IOException {
      ArrayShort.D0 a = (ArrayShort.D0) ncVar.read();
      setValue( a.get());
