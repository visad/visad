// $Id: NcSDFloat32.java,v 1.1.1.1 2002-06-05 21:43:44 steve Exp $
/*
 ...
 * @author jcaron
 */
public class NcSDFloat32 extends SDFloat32 implements HasProxyObject {
  ...
  */
  ...
  public boolean read(String datasetName, Object specialO) throws IOException {
      ArrayFloat.D0 a = (ArrayFloat.D0) ncVar.read();
      setValue( a.get());
