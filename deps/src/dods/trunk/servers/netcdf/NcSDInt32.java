// $Id: NcSDInt32.java,v 1.1.1.1 2002-06-05 21:43:45 steve Exp $
/*
 ...
 * @author jcaron
 */
public class NcSDInt32 extends SDInt32 implements HasProxyObject {
  ...
  */
  ...
  public boolean read(String datasetName, Object specialO) throws IOException {
      ArrayInt.D0 a = (ArrayInt.D0) ncVar.read();
      setValue( a.get());
