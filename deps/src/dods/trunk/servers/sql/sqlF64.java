...
public  class sqlF64 extends SDFloat64 {
    ...
    */
	...
	int column = sqlRes.getCurrentColumn();
		...
		if(_Debug) System.out.println("ResultSet Column " + column + " contains a NULL value!");
		b = Double.NaN;
	    }
	...
	if(_Debug) System.out.println("Float64 received from SQl Query: \"" + b +"\"");
