...
/* $Id: drds.java,v 1.3 2004-02-06 15:23:50 donm Exp $
*
*/
...
public class drds extends dodsSQLServlet {
     ...
     */
    protected GuardedSQLDataset getSQLDataset(requestState rs) throws DODSException, IOException, ParseException {
