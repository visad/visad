...
public class test_SDBoolean extends SDBoolean {
    ...
    /** Constructs a new <code>test_SDBoolean</code>. */
    public test_SDBoolean() { 
        super(); 
    }

    /**
    * Constructs a new <code>test_SDBoolean</code> with name <code>n</code>.
    * @param n the name of the variable.
    */
    public test_SDBoolean(String n) { 
        super(n); 
    }
