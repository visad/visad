...
# NOTE: make sure version of Java you want to test is on your path before starting
#set JAVA=c:\jdk1.6.0_29
#set path=%JAVA%\jre\bin;%JAVA%\bin;%path%
CLASSPATH=../visad.jar
CLASSPATH=$CLASSPATH:../visad_examples.jar
CLASSPATH=$CLASSPATH:.
...
echo 'button for direct manipulation in the right display), and'
...
echo 'finally Reset and Apply; verify proper color change in'
