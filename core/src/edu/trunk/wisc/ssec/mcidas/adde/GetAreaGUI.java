...
public class GetAreaGUI extends javax.swing.JDialog {
  ...
  */
  ...
  private void setupGUI(String s, boolean multi, boolean coa) {
    ...
    try {
      FileInputStream fi = new FileInputStream("GetAreaGUI.properties");
      dataProp.load(fi);
      fi.close();
    } catch (Exception e) {;}
  ...
  private void initComponents() {//GEN-BEGIN:initComponents
    ...
    PanelSGD.setMaximumSize(new java.awt.Dimension(500, 160));
      ...
      PanelServer.setLayout(new java.awt.GridLayout(2, 1));
        ...
        PanelServer.setBorder(new javax.swing.border.BevelBorder(0));
      ...
      PanelGroup.setLayout(new java.awt.GridLayout(2, 1));
        ...
        PanelGroup.setBorder(new javax.swing.border.BevelBorder(0));
    ...
    PanelDescr.setLayout(new java.awt.BorderLayout());
      PanelDescr.setBorder(new javax.swing.border.BevelBorder(0));
    ...
    PanelMag.setLayout(new java.awt.BorderLayout(10, 5));
      ...
      jPanel13.setLayout(new java.awt.BorderLayout(10, 0));
        jPanel13.setBorder(new javax.swing.border.BevelBorder(0));
    ...
    PanelList.setLayout(new java.awt.BorderLayout(0, 10));
      ...
      DateTimeScrollPanel.setPreferredSize(new java.awt.Dimension(180, 150));
        ...
        DateTimeList.setToolTipText("Click on the date-time you want");
          DateTimeList.setBorder(new javax.swing.border.BevelBorder(0));
    ...
    LinesElesPanel.setLayout(new java.awt.BorderLayout());
      LinesElesPanel.setBorder(new javax.swing.border.BevelBorder(0));
    ...
    BandPanel.setLayout(new java.awt.BorderLayout());
      BandPanel.setBorder(new javax.swing.border.SoftBevelBorder(0));
    ...
    UnitsPanel.setLayout(new java.awt.BorderLayout());
      UnitsPanel.setBorder(new javax.swing.border.SoftBevelBorder(0));
    ...
    userActionButton.setToolTipText("Click button to "+actionButtonString);
      userActionButton.setLabel(actionButtonString);
    ...
    PanelLoc.setBorder(new javax.swing.border.BevelBorder(0));
    
    jPanel11.setLayout(new java.awt.FlowLayout(1, 5, 0));
...
// Add your handling code here:
  ...
  private void userActionButtonActionPerformed (java.awt.event.ActionEvent evt) {//GEN-FIRST:event_userActionButtonActionPerformed
    ...
    try {
      FileOutputStream fo = new FileOutputStream("GetAreaGUI.properties");
    ...
    String cmdout = "adde://"+getServer()+"/imagedata?group="+getGroup()+
