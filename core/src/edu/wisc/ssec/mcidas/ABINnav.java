...
public class ABINnav extends AREAnav {
    ...
    private static final double rdpdg = 1.745329252E-2;

    private static final double bsq = 40410330.18;

    private static final double asq = 40683833.48;

    private static final double ab = 40546851.22;

    private static final double dh = 42164.16000000000349245965480804443359375;
    private static final double deg_to_rad = PI / 180.0;
    private static final double dreq2 = 6378.136999999999716237653046846389770508 * 6378.136999999999716237653046846389770508;
    private static final double drpo = 6356.752300000000104773789644241333007812;
    private static final double drpo2 = drpo * drpo;

    // radius of the Earth at the equator squared
    private static final double r_eq2 = 6378.136999999999716237653046846389770508 * 6378.136999999999716237653046846389770508;
    private static final double d = 42164.16000000000349245965480804443359375 * 42164.16000000000349245965480804443359375 - r_eq2;
    ...
    public double[][] toLatLon(double[][] linele) {
        ...
        double s3;
        double sxy;
        double sub_lon_radians = plon * (PI / 180.0);
        ...
        for (int point = 0; point < length; point++) {
            ...
            c1 = 42164.16000000000349245965480804443359375 * cosx * cosy * 42164.16000000000349245965480804443359375 * cosx * cosy;
            c2 = (cosy * cosy + 1.006802999999999892466462370066437870264 * siny * siny) * d;
            //
            sdd = c1 - c2;
            if ((sdd < 0.0))  {
                xlat = Double.NaN;
                ...
                sd = sqrt(sdd);
                //
                sn = (42164.16000000000349245965480804443359375 * cosx * cosy - sd) / (cosy * cosy + 1.006802999999999892466462370066437870264 * siny * siny);
                //
                s1 = 42164.16000000000349245965480804443359375 - sn * cosx * cosy;
                s2 = sn * sinx * cosy;
                s3 = -(sn * siny);
                //
                ...
                //
                xlat = atan(-(1.006802999999999892466462370066437870264 * s3 / sxy));
...
//            lineEles[indexLine][point] = lineEle[0];
//            lineEles[indexEle][point] = lineEle[1];
