...
*/
    ...
    VisADSlider slider300 = new VisADSlider("num300", 0, 300, 600, 1.0,
                                            ref300, RealType.Generic);
    VisADSlider slider1_4 = new VisADSlider("num1_4", 0, 140, 280, 0.01,
                                            ref1_4, RealType.Generic);
    big_panel.add(slider300);
    big_panel.add(slider1_4);
