...
McIDAS system.  The code in this file is Copyright(C) 1998 by Tom
...
/**
 * The GVARnav class creates the ability to navigation GVAR
...
// multiplication of matrices a and rpy
  ...
  public double[][] toLatLon(double[][] linele) { 
    ...
    for (int point=0; point<number; point++) {
      ...
      rp = startImageElement + (resElement * (rp - startElement))/magElement;
   ...
   *
   * @param ersElement is the resolution in the 'element'
   ...
   *
   * @param startLine the starting line number in another coordinate system
   *
   ...
   *
   * @param startImageLine redefines the starting image line
   * number (may be different than the signal indicated)
   *
   * @param startImageElement redefines the starting image element
   * number (may be different than the signal indicated)
   *
   */
