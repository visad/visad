...
/**
   IntegerSet represents a finite set of samples of R^n at
   an integer lattice based at the origin.<P>
*/
public class IntegerSet extends LinearSet {

  public IntegerSet(MathType type, int[] lengths) throws VisADException {
    this(type, lengths, null, null, null);
  }

  public IntegerSet(MathType type, int[] lengths,
                    CoordinateSystem coord_sys, Unit[] units,
                    ErrorEstimate[] errors) throws VisADException {
    super(type, LinearSet.get_linear1d_array(type, get_firsts(lengths),
    ...
    switch (lengths.length) {
      ...
      case 3:
        return new Integer3DSet(type, lengths[0], lengths[1], lengths[2],
                                coord_sys, units, errors);
      default:
        return new IntegerSet(type, lengths,
                              coord_sys, units, errors);
    }
  }
  ...
  public Object clone() {
    try {
      ...
      return new IntegerSet(Type, lens, DomainCoordinateSystem,
                            SetUnits, SetErrors);
    }
    catch (VisADException e) {
      throw new VisADError("IntegerSet.clone: " + e.toString());
    }
  }
  ...
  public String longString(String pre) throws VisADException {
    String s = pre + "IntegerSet: Dimension = " +
