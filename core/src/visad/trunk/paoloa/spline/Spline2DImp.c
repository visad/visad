 ...
 * Method:    visad_tpspline_c
 * Signature: ([D[D[D[D[DII)V
 */
JNIEXPORT void JNICALL Java_visad_paoloa_spline_Spline2D_visad_1tpspline_1c
  (JNIEnv *env, jobject obj, jdoubleArray x_array_j, jdoubleArray y_array_j,
   ...
   jint dimen1_j, jint dimen2_j) {
    ...
    visad_tpspline_(x_array, y_array, s_array, ytrue, y, dimen1_j, dimen2_j);
