...
/**
   The ShadowFunctionOrSetType class is an abstract parent
   for ShadowFunctionType and ShadowSetType.<P>
*/
public abstract class ShadowFunctionOrSetType extends ShadowType {
  ...
  ShadowFunctionOrSetType(MathType t, DataDisplayLink link, ShadowType parent)
...
*/
    ...
    if (isTerminal) {
      ...
      TransparencyAttributes constant_alpha = new TransparencyAttributes();
...
*/
      ...
      for (int j=0; j<display.valueArrayLength; j++) {
