 ...
 *
 * $Id: SingleSoundingProxy.java,v 1.1 1998-11-03 22:27:35 steve Exp $
 */
    ...
    extends	SingleSounding
{
    ...
    /**
     * Constructs from a FlatField to be proxied and an index of the 
     * single component in the field that is to constitute the range of
     * this proxy.
     *
     * @param rangeType		The type of the range.
     * @param field		The FlatField to be adapted.
     * @param index		Range-index of the component of the field.
     ...
     */
    public
    SingleSoundingProxy(MathType rangeType, FlatField field, int index)
	throws VisADException
    {
	this(rangeType, field, new int[] {index});
    }
     ...
     */
    public
    SingleSoundingProxy(MathType rangeType, FlatField field, int[] indexes)
	throws VisADException
    {
	super(
	    rangeType,
