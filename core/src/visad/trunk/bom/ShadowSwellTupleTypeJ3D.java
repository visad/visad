...
/**
   The ShadowSwellTupleTypeJ3D class shadows the TupleType class for
   SwellRendererJ3D, within a DataDisplayLink, under Java3D.<P>
*/
public class ShadowSwellTupleTypeJ3D extends ShadowTupleTypeJ3D {

  public ShadowSwellTupleTypeJ3D(MathType t, DataDisplayLink link,
                                ShadowType parent)
