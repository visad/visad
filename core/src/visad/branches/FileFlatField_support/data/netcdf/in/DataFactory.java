 ...
 *
 * $Id: DataFactory.java,v 1.1.2.1 2000-06-08 19:05:23 steve Exp $
 */
...
DataFactory
{
    ...
    /**
     * Creates a VisAD Real object from a netCDF indicial context and a 
     * VirtualScalar.
     *
     * @param context		The netCDF indicial context.
     ...
     * @throws IOException	I/O failure.
     */
    public Real newData(Context context, VirtualScalar virtualScalar)
	throws VisADException, InvalidContextException, IOException
    {
	double[]	values = virtualScalar.getDoubles(context);
	...
	return
	    new Real(
		(RealType)virtualScalar.getScalarType(),
		values[0],
